 ...
 */
export function getMcpToolForProvider(provider) {
 ...
 */
export function resolveModelForAgent(agentName, staticTier, projectRoot) {
 ...
 */
function resolveFromAgentConfig(agentConfig, staticTier, projectRoot) {
 ...
 */
export function isProviderAvailable(resolved) {
    if (resolved.type === 'claude')
        return true;
 ...
 */
export function getFallbackModel(resolved) {
    return {
        type: 'claude',
 ...
 */
export function resolveModelWithFallback(agentName, staticTier, projectRoot) {
